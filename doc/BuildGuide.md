...
![2025-06-19_11h00_17](https://github.com/user-attachments/assets/e32b33d4-b18b-44d7-b2aa-5ac9f758da3f)
...
- 先にボトムケースから基板ごと取り出し、裏側のFPCを外してから分解する
  ...
  - なので、先に基板ごと取り外して、裏面にアクセスし、FPCソケットからFPCを外したのち、マイコンを取り外すと安全です。
...
- また、トラックパッドだけの不具合の場合、SPI端子（MOSI,MISO,SCK,DR）のはんだ不良も合わせて見直してみてください。
