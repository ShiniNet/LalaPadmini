...
### 基板へFFC（フレキシブルフラットケーブル）とトラックパッドとエンコーダーを接続する
### 基板へマイコン（FPC）の取り付け

<br><br>

## 動作確認
### マイコンへファームウェアの書き込み&動作確認（USB）
- FPCが破損しやすいのでUSBへの抜き差しは慎重に。デバッグ中は主にPC側のUSBを抜き差しすることを推奨。
### 動作確認（バッテリー）
...
## キーボードの組み立て
### ボトムプレートにTPUマウントと基板とスイッチカバーをセットする
### トッププレートをかぶせて装着する
### マイコンカバーを取り付ける
