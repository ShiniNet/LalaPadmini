...
||Magsafeスタンド|2個|平置きで親指ポインター操作は疲れるので、テンティングすることをお勧めします。（CamoloのMagsafeスタンド最強）|[Amazon](https://www.amazon.co.jp/dp/B0DLN31XJ3/) [Official](https://camolomall.com/products/camolo-mg03-pro-ultra-thin-magnetic-tri-fold-phone-holder)|
...
|大|PCB固定ホルダー|マイコンを机に固定する用。マスキングテープで代用可能。|[アリエク](https://ja.aliexpress.com/item/1005007709883885.html)|
|中|ニッパー|基板の分離用。||
