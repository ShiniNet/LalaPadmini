...
A: 可能です。ショップオーナーにご相談ください。部品種別によっては国際配送料がかかる場合ことを予めご了承ください。または[BOM](doc/partsList.md)を参考にユーザー自身でパーツを調達することもできます。
　※基板の故障については基本的に修理交換となり、お手元にある基盤の返送をお願いする場合があります。
